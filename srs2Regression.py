...
# Usage: python srs2Regression.py [-h] [-r] [-e] [-d] [-l] [-u]
# Arguments:
...
testInfo = {   'assessmentform': 'Adult Relative/Other Report Form',
    'assessmenttype': 'srs2',
    'clientagedays': '0',
    'clientagemonths': '0',
    'clientageyears': '45',
    'clientcaseid': '',
    'clientemail': '',
    'clientfirstname': 'SRS2-QA',
    'clientgender': 'Male',
    'clientlastname': 'Sample',
    'password': '',
    'respondentname': 'Sample-case',
    'scoreform': True,
    'username': '',
    'validateformmessage': 'This form is now ready to score. Please click OK '
                           'to continue.'}

argsListAssessment = {'Individual Information': {'Ethnicity': 'American Indian/Alaska Native'},
    'Rater Information': {'Relationship to rated individual': 'Spouse'}}

argsListValidation = {   'For Examiner Use Only': {"Examiner's name": 'Linda'}}

questionList = {   'Adult (Relative/Other Report) Form': {   'q1': ['1'],
                                              'q10': ['2'],
                                              'q11': ['3'],
                                              'q12': ['3'],
                                              'q13': ['3'],
