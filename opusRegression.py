...
# Usage: python opusRegression.py [-h] [-r] [-e] [-d] [-l] [-u]
# Arguments:
...
argsListAssessment = {   'Client Information': {'Norms basis: Age or grade': 'Grade',
    'Grade (Note: If administered in summer, enter the grade the examinee '
        'will enter in the Fall.)':
        '4',
    'Term': 'Fall',
    'Dialect': 'English',
    'School/Agency': 'Test School',
    'Reason for assessment': 'poor quality of classwork; low grades'},
    'Examiner Information': {'Examiner Name/ID': 'Dr. Fisher',
    'Confidence interval': '95'},
    'Item Set Information': {'Item Set': 'Item Set C'}}

argsListValidation = {}

questionList = {   'Passage 10': {   'q1': ['0'],
                      'q2': ['1'],
                      'q3': ['0'],
                      'q4': ['0'],
                      'q5': ['1'],
