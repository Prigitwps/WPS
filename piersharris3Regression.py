# Piers-Harris-3 test module for OES 1.0
# Requirements:
...
# Usage: python piersharris3Regression.py [-h] [-r] [-e] [-d] [-l] [-u]
# Arguments:
...
testInfo = {   'assessmentform': 'Spanish Form',
    'assessmenttype': 'piersharris3',
    'clientagedays': '0',
    'clientagemonths': '3',
    'clientageyears': '10',
    'clientcaseid': '',
    'clientemail': '',
    'clientfirstname': 'PH3-QA',
    'clientgender': 'Male',
...
argsListAssessment = {   'Información del Cliente': {'Escuela/Clinica': 'Test School',
    'Grado': '5',
    'Raza/Origen Étnico': 'Hispano/Latinoamericano',
    'Sexo': ['Masculino', True]}
    }

argsListValidation = {'Examiner Information': {'Examiner': 'Dr. Fisher'}}

questionList = {   'Spanish Form': {   'q1': ['Sí'],
                        'q10': ['No'],
                        'q11': ['No'],
                        'q12': ['No'],
                        'q13': ['No'],
