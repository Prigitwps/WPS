...
# Usage: python dbc2Regression.py [-h] [-r] [-e] [-d] [-l] [-u]
# Arguments:
...
testInfo = {   'assessmentform': 'Teacher Form',
    'assessmenttype': 'dbc2',
    'clientagedays': '0',
    'clientagemonths': '6',
    'clientageyears': '7',
...
argsListAssessment = {   'Client Information': {'Name of person completing': 'Ms. Sue',
    'Relationship to individual': 'Mother',
    'Type of school/class individual attends': 'Special class',
    'Programs or activities that he or she has been unable to participate '
        'in':
        'dance class',
    'The amount of time per week he or she is absent due to behavioral '
        'problems':
        '1 day',
    'amount of time spent in productive learning': '25%',
    "How the individual's productive learning time": 'Less',
       'How much time the individual requires from you compared with others '
        'in the class during class instruction time':
        'More',
    'How much time the individual requires from you compared with others '
        'in the class during non-classroom time':
        'About the same'}
    }

argsListValidation = {   'For Examiner Use Only':{'Degree of Intellectual and Developmental Disability': 'Mild',
    'Normative basis': 'United States'}}

questionList = {   'Teacher Items': {   'q1': ['2'],
                         'q10': ['0'],
                         'q11': ['0'],
                         'q12': ['0'],
                         'q13': ['0'],
...
def runTest(env="uat", headless=False, randomResponse=False, directory=None, logName=None):
    ...
    try:
        ...
        if (completedForm1 is not None and completedForm1 != '') and (completedForm2 is not None and completedForm2 != ''):
            ...
            try:
                Prac.generateReport(reportType='Respondent Comparison', formIds=[completedForm1, completedForm2], reportInformation={'title': None, 'description': None})
            except:
                logger.error("Failed to generate Respondent Comparison report!!!")
                
            Prac.browser.refresh()
            
            try:
                Prac.generateReport(reportType='Item-Level Progress Monitoring', formIds=[completedForm1], reportInformation={'title': None, 'description': None, 'questions': [['', '1'], ['', '10'], ['', '34']]})
            except:
                logger.error("Failed to generate Item-Level Progress Monitoring report!!!")
        else:
