...
# Usage: python spmpRegression.py [-h] [-r] [-e] [-d] [-l] [-u]
# Arguments:
...
testInfo = {   'assessmentform': 'Spanish School Form',
    'assessmenttype': 'spmp',
    'clientagedays': '0',
    'clientagemonths': '2',
    'clientageyears': '4',
...
argsListAssessment = {'Información del Maestro o de la Maestra o Encargado/a de la Guardería': {'Su Nombre': 'Hermano Sample',
    'Su Relación': 'Brother'},
    'Información del Niño o de la Niña': {'Sexo': 'Femenino',
    'Raza/Origen': 'Hispano/Latinoamericano'}}

argsListValidation = {}

questionList = {   'Conciencia del cuerpo': {   'q46': ['Nunca'],
                                 'q47': ['Ocasionalmente'],
                                 'q48': ['Nunca'],
                                 'q49': ['Ocasionalmente'],
                                 'q50': ['Nunca'],
                                 ...
                                 'q54': ['Ocasionalmente'],
                                 'q55': ['Nunca']},
    'Equilibrio y movimiento': {   'q56': ['Nunca'],
                                   'q57': ['Nunca'],
                                   'q58': ['Ocasionalmente'],
                                   'q59': ['Ocasionalmente'],
                                   'q60': ['Nunca'],
    ...
    'Oído': {   'q21': ['Nunca'],
                ...
                'q29': ['Nunca'],
                'q30': ['Nunca']},
    'Participación social': {   'q1': ['Siempre'],
                                'q10': ['Siempre'],
                                'q2': ['Siempre'],
                                'q3': ['Frecuentemente'],
                                'q4': ['Nunca'],
                                ...
                                'q8': ['Frecuentemente'],
                                'q9': ['Siempre']},
    'Planificación e ideas': {   'q66': ['Nunca'],
                                 'q67': ['Ocasionalmente'],
                                 'q68': ['Nunca'],
                                 'q69': ['Nunca'],
                                 'q70': ['Nunca'],
