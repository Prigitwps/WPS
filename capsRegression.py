...
# Usage: python capsRegression.py [-h] [-r] [-e] [-d] [-l] [-u]
# Arguments:
...
argsListAssessment = {   'Examiner Information': {"Examiner's name": 'Mrs. Smith',
    "Examiner's title": 'School Psychologist'},
    'Client Information': {'Grade': '6',
    'School': 'Test School'}
    }

argsListValidation = {}

questionList = {   'Affective Expression': {   'q1': ['0'],
                                'q2': ['1'],
                                'q3': ['0'],
                                'q4': ['0'],
                                'q5': ['0'],
    ...
    'Instrumental Performance': {   'q1': ['1'],
                                    ...
                                    'q5': ['0'],
                                    'q6': [   '0',
                                              'They also sort of shrugged when '
                                              'they responded'],
                                    'q7': ['1'],
                                    'q8': ['2']},
