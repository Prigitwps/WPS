...
# Usage: python riseRegression.py [-h] [-r] [-e] [-d] [-l] [-u]
# Arguments:
...
testInfo = {   'assessmentform': 'Self Form',
    'assessmenttype': 'rise',
    'clientagedays': '0',
    'clientagemonths': '4',
    'clientageyears': '22',
...
argsListAssessment = {'Client Information': {'School': 'Test School', 'Grade': 'Attending college'}}

argsListValidation = {}

questionList = {   'Self Items': {   'q1': ['Sometimes'],
                      'q10': ['Rarely'],
                      'q11': ['Sometimes'],
                      'q12': ['Sometimes'],
                      'q13': ['Very often'],
