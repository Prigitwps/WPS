...
# Usage: python dp3Regression.py [-h] [-r] [-e] [-d] [-l] [-u]
# Arguments:
...
testInfo = {   'assessmentform': 'Interview Form',
    'assessmenttype': 'dp3',
    'clientagedays': '0',
    'clientagemonths': '2',
    'clientageyears': '4',
    ...
    'username': '',
    'validateform': True,
    'validateformmessage': 'Some items are missing responses. Please edit the form to complete missing items and check for an accurate basal and ceiling (5 items each) or click on Score Form to generate the report. Any missing item will be scored 0 (except below the basal).'}


argsListAssessment = {   'Child Information': {"Child's ID": '6001',
    "Child's ethnicity": 'White'},
    'Rater Information': {"Informant's name": 'Ms. Smith',
    'Relationship to child': 'Mother'}}

argsListValidation = {   'For Examiner Use Only': {"Examiner's ID": 'Linda', 'Confidence interval': '95'}}

questionList = {   'Adaptive Behavior Scale': {   'q1': ['skip'],
                                   'q10': ['Y'],
                                   'q11': ['Y'],
                                   'q12': ['Y'],
                                   'q13': ['Y'],
    ...
    'Physical Scale': {   'q1': ['skip'],
                          ...
                          'q8': ['skip'],
                          'q9': ['Y']},
    'Social-Emotional Scale': {   'q1': ['skip'],
                                  'q10': ['Y'],
                                  'q11': ['N'],
                                  'q12': ['Y'],
                                  'q13': ['Y'],
...
def runTest(env="uat", headless=False, randomResponse=False, directory=None, logName=None):
    ...
    try:
        ...
        if (completedForm1 is not None and completedForm1 != '') and (completedForm2 is not None and completedForm2 != ''):
            ...
            try:
                Prac.generateReport(reportType='Intervention', formIds=[completedForm1], reportInformation={'title': None, 'description': None, 'questions': [['Communication', '1'], ['Physical', '10'], ['Communication', '34']]})
            except:
