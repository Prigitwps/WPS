# RCMAS-2 test module for OES 1.0
# Requirements:
...
# Usage: python rcmas2Regression.py [-h] [-r] [-e] [-d] [-l] [-u]
# Arguments:
...
testInfo = {   'assessmentform': 'Full Form',
    'assessmenttype': 'rcmas2',
    'clientagedays': '0',
    'clientagemonths': '11',
    'clientageyears': '7',
    'clientcaseid': '',
    'clientemail': '',
    'clientfirstname': 'RCMAS2-QA',
    'clientgender': 'Female',
...
argsListAssessment = {   'Client Information': {'Grade': '3',
    'Race/Ethnicity': 'Hispanic/Latino',
    'School': 'Santa monica high school'}}

argsListValidation = {'Examiner Information': {"Examiner's name": 'Dr. Fisher'}}

questionList = {   'Full Form': {   'q1': ['Yes'],
                     'q10': ['No'],
                     'q11': ['No'],
                     'q12': ['Yes'],
                     'q13': ['Yes'],
