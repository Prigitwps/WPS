# SMALSI test module for OES 1.0
# Requirements:
...
# Usage: python smalsiRegression.py [-h] [-r] [-e] [-d] [-l] [-u]
# Arguments:
...
testInfo = {   'assessmentform': 'College Form',
    'assessmenttype': 'smalsi',
    'clientagedays': '0',
    'clientagemonths': '0',
    'clientageyears': '18',
    'clientcaseid': '7001',
    'clientemail': '',
    'clientfirstname': 'SMALSI-QA',
    'clientgender': 'Male',
    ...
    'username': '',
    'validateform': True,
    'validateformmessage': 'This form is now ready to score. Please click OK to continue.'}

argsListAssessment = {'Client Information': {'Class': 'Graduate', 'Race/Ethnicity': 'White'}}

argsListValidation = {   'For Examiner Use Only': {"Examiner's ID": 'Linda'}}

questionList = {   'College Form': {   'q1': ['S'],
                        'q10': ['O'],
                        'q100': ['S'],
                        'q101': ['S'],
                        'q102': ['N'],
