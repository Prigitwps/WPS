# PPA Scale test module for OES 1.0
# Requirements:
...
# Usage: python ppascaleRegression.py [-h] [-r] [-e] [-d] [-l] [-u]
# Arguments:
...
testInfo = {   'assessmentform': 'Form A',
    'assessmenttype': 'ppascale',
    'clientagedays': '0',
    'clientagemonths': '9',
    'clientageyears': '5',
    'clientcaseid': '6001',
    'clientemail': '',
    'clientfirstname': 'PPAScale-QA',
    'clientgender': 'Female',
...
argsListAssessment = {   'Examiner Information': {'Name/ID': 'Ms. Smith'},
    'Client Information': {'Name/ID': 'PPAScale-QA Sample',
    'Gender': 'Female',
    'Dialect': 'English',
    'School': 'Test School',
    'Grade': 'Pre-School',
    'Reason for assessment': 'The child has hearing problem.',
    'Confidence Interval': '95'}}
    # Had this here, not sure why; doesn't seem to be a field on the form???
    # "Examiner's title": 'School Psychologist'}}

argsListValidation = {}

questionList = {   'Final Sound Matching': {   'q1': ['3'],
                                'q2': ['3'],
                                'q3': ['1'],
                                'q4': ['3'],
                                'q5': ['3'],
...
# def runTest(env="uat", headless=False, randomResponse=False, directory=None, input=None, waitTime=None):
    ...
    try:
        ...
        try:
            ...
            logging.warning("Deleting client failed!!!")
