...
setuptools.setup(
    ...
    # entry_points={
        # 'console_scripts': ['oesLibrary-path=oesLibrary.oesObject:printOesLibraryPath'],
    # },
    # include_package_data=True,    
    # package_data={
        # "ImageMagick": ["oesLibrary/ImageMagick/*"]
    # },
    classifiers=[
...
# installation_path = setupCommand.command_obj['install'].__dir__()
